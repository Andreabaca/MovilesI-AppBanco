    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agregarCuenta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*if(!nroCuentaAgregar.getText().toString().isEmpty()){
                    if(!emailAgregar.getText().toString().isEmpty()){
                        if(!fechaAgregar.getText().toString().isEmpty()){
                            if(!balanceAgregar.getText().toString().isEmpty())};
                    }
                }*/
